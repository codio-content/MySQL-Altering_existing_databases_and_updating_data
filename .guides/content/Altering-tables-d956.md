We've learned how to _update_ the values of specific table columns and rows, but what about updating a table's name, a table column's name or its data types? 
